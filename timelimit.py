...
excluded_processes = ['devenv.exe', 'HopToDesk.exe', 'msedge.exe', "rustdesk.exe", "LuaForWindows_v5.1.5-52.exe", "lua.exe", "cmd.exe", "luvit.exe", "luvi.exe", "lit.exe"]  # List of process names to exclude
